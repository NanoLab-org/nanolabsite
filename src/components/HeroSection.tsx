...
export default function HeroSection() {
  ...
  return (
    <section
      id="accueil"
      className="relative h-[calc(100vh-72px)] flex items-center justify-center overflow-hidden bg-white dark:bg-nl-dark"
    >
      <BackgroundPaths />
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <div className="space-y-8">
          <motion.div
            ...
            className="space-y-6"
          >
            <h1 className="font-syne font-extrabold text-5xl sm:text-6xl lg:text-[64px] lg:leading-[1.05] lg:tracking-[-3.2px] text-nl-primary dark:text-white leading-tight">
              NanoLab —{" "}
              <motion.span
